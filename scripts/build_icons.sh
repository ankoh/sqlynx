...
iconutil -c icns ./misc/logo-dashql-glyphs/app_icons_mac.iconset

ICONSET=./misc/logo-dashql-glyphs/app_icons_mac.iconset/
ICNS=./misc/logo-dashql-glyphs/app_icons_mac.icns
