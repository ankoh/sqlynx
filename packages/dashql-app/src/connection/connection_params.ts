...
export function encodeConnectionParams(state: ConnectionParamsVariant, settings: WorkbookExportSettings | null = null): proto.dashql_connection.pb.ConnectionParams {
    switch (state.type) {
        case SERVERLESS_CONNECTOR:
