...
static void reindex_sorting(benchmark::State& state) {
    rope::Rope input_external{1024, external_script};
    rope::Rope input_main{1024, main_script};
...
static void reindex_bulkloading(benchmark::State& state) {
    rope::Rope input_external{1024, external_script};
    rope::Rope input_main{1024, main_script};
...
BENCHMARK(reindex_sorting);
BENCHMARK(reindex_bulkloading);
