...
export const EXAMPLES: ExampleSchemas = {
    TPCH: {
        ...
        queries: [
            ...
            example(ScriptType.QUERY, 'tpch_q10.sql', tpch_q10, TPCH_SCHEMA.scriptId, { tableRefs: [] }),
            example(ScriptType.QUERY, 'tpch_q11.sql', tpch_q11, TPCH_SCHEMA.scriptId, { tableRefs: [] }),
            example(ScriptType.QUERY, 'tpch_q12.sql', tpch_q12, TPCH_SCHEMA.scriptId, { tableRefs: [] }),
            example(ScriptType.QUERY, 'tpch_q13.sql', tpch_q13, TPCH_SCHEMA.scriptId, { tableRefs: [] }),
            example(ScriptType.QUERY, 'tpch_q14.sql', tpch_q14, TPCH_SCHEMA.scriptId, { tableRefs: [] }),
            example(ScriptType.QUERY, 'tpch_q15.sql', tpch_q15, TPCH_SCHEMA.scriptId, { tableRefs: [] }),
            example(ScriptType.QUERY, 'tpch_q16.sql', tpch_q16, TPCH_SCHEMA.scriptId, { tableRefs: [] }),
            example(ScriptType.QUERY, 'tpch_q16.sql', tpch_q17, TPCH_SCHEMA.scriptId, { tableRefs: [] }),
            example(ScriptType.QUERY, 'tpch_q18.sql', tpch_q18, TPCH_SCHEMA.scriptId, { tableRefs: [] }),
            example(ScriptType.QUERY, 'tpch_q19.sql', tpch_q19, TPCH_SCHEMA.scriptId, { tableRefs: [] }),
            example(ScriptType.QUERY, 'tpch_q20.sql', tpch_q20, TPCH_SCHEMA.scriptId, { tableRefs: [] }),
            example(ScriptType.QUERY, 'tpch_q21.sql', tpch_q21, TPCH_SCHEMA.scriptId, { tableRefs: [] }),
            example(ScriptType.QUERY, 'tpch_q22.sql', tpch_q22, TPCH_SCHEMA.scriptId, { tableRefs: [] }),
        ]
    },
    TPCDS: {
        name: "TPC-DS",
