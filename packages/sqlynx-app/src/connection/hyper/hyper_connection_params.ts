...
export function buildHyperConnectionParams(params: HyperGrpcConnectionParams, _settings: WorkbookExportSettings | null): proto.sqlynx_connection.pb.ConnectionParams {
