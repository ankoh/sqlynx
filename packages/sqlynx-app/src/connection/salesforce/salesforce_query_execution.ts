...
export async function executeSalesforceQuery(conn: SalesforceConnectionDetails, args: QueryExecutionArgs, progressUpdates: AsyncValueTopic<QueryExecutionProgress>): Promise<QueryExecutionResponseStream> {
