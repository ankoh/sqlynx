...
export const SchemaGraph: React.FC<Props> = (props: Props) => {
    ...
    const schemaGraphLayout = buildSchemaGraphLayout(state);
    const debugInfo = buildDebugInfo(state, schemaGraphLayout.nodes);
    return (
        <div className={cn(styles.graph_container, props.className)}>
            ...
            <EdgeLayer
                ...
                edges={schemaGraphLayout.edges}
            />
            <NodeLayer
                className={styles.graph_nodes}
                width={props.width}
                height={props.height}
                nodes={schemaGraphLayout.nodes}
                edges={schemaGraphLayout.edges}
            />
